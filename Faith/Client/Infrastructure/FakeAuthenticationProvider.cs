...
namespace Client.Infrastructure
{
    public class FakeAuthenticationProvider : AuthenticationStateProvider
    {
        ...
        public static ClaimsPrincipal Begeleider => new(new ClaimsIdentity(new[]
        {
        ...
        public static ClaimsPrincipal Jongere => new(new ClaimsIdentity(new[]
        {
        ...
        {
            return Task.FromResult(new AuthenticationState(Begeleider));
        }
    }
}
